...
// RZImposter
#define COCOAPODS_POD_AVAILABLE_RZImposter
#define COCOAPODS_VERSION_MAJOR_RZImposter 0
#define COCOAPODS_VERSION_MINOR_RZImposter 1
#define COCOAPODS_VERSION_PATCH_RZImposter 0
